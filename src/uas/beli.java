...
public class beli extends javax.swing.JFrame {
    ...
    public long kembali;
    public Statement st;
    Connection cn = config.getKoneksi();
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(hitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 100, 30));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 300, 190, 30));
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")){
            ...
            if(aa > bb){
                JOptionPane.showMessageDialog(null, "jumlah melebihi stok", "TOKO BESI", JOptionPane.INFORMATION_MESSAGE);
                tjumlah.setText("");
            }else{
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            ...
            try {
                ...
                tjumlah.setText("");
                ttotal.setText("");
                JOptionPane.showMessageDialog(null, "Data berhasil disimpan", "toko besi", JOptionPane.INFORMATION_MESSAGE);
                loadData();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField3.getText().equals("") ||jTextField1.getText().equals("")){
            ...
            if(ab < 0){
                JOptionPane.showMessageDialog(null, "Uang anda kurang", "TOKO BESI", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
                jTextField1.setText("");
            }else{
                try {
                    ...
                    try {
                        ...
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "TRANSAKSI SELESAI", "TOKO besi", JOptionPane.INFORMATION_MESSAGE);
                        loadData();
