...
public class inputbarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, -1, 20));
        ...
        jPanel1.add(thargajual, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 150, 230, 30));
        ...
        jPanel1.add(tkdbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 80, 230, 30));
        ...
        jPanel1.add(tnamabarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 230, 30));
        ...
        jPanel1.add(tjumlahbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 230, 30));
        ...
        jPanel1.add(thargabeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 90, 230, 30));

        bedit.setBackground(new java.awt.Color(204, 204, 204));
        bedit.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bedit.setForeground(new java.awt.Color(255, 255, 0));
        bedit.setText("EDIT");
        ...
        jPanel1.add(bedit, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 100, 50));

        bsimpan.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        bsimpan.setForeground(new java.awt.Color(102, 255, 102));
        ...
        bhapus.setForeground(new java.awt.Color(255, 0, 102));
        ...
        jPanel1.add(bhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, 100, 50));
        ...
        jPanel1.add(tcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, 270, 30));
        ...
        jPanel2.add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, -1, 40));
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        if(tkdbarang.getText().equals("") ||tnamabarang.getText().equals("") || tjumlahbarang.getText().equals("")|| thargabeli.getText().equals("")|| thargajual.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "toko BESI", JOptionPane.INFORMATION_MESSAGE);
        }else{
            ...
            try {
                ...
                thargajual.setText("");
                bsimpan.setEnabled(true);
                JOptionPane.showMessageDialog(null, "Data berhasil diubah", "toko besi", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if(tkdbarang.getText().equals("") ||tnamabarang.getText().equals("") || tjumlahbarang.getText().equals("")|| thargabeli.getText().equals("")|| thargajual.getText().equals("")){
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Data berhasil tersimpan", "toko besi", JOptionPane.INFORMATION_MESSAGE);
            }
        }
